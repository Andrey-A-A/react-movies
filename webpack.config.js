...
// Импортируем плагин
const Dotenv = require('dotenv-webpack'); //Безопасный плагин webpack, который поддерживает dotenv и другие переменные среды, Dotenv - это модуль с нулевой зависимостью, который загружает переменные окружения из файла .env в process.env. (можно передавать таким образом секретные ключи)
...
const plugins = [
  ...
  new Dotenv(), //добавляю плагин dotenv-webpack который 
